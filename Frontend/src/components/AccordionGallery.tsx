    ...
    (animate: boolean) => {
      ...
      panels.forEach((panel, i) => {
        ...
        if (media) {
          ...
          const grayVal = grayscale ? (isActive ? 'grayscale(0%)' : 'grayscale(100%)') : 'grayscale(0%)';
          tl.to(
            media,
            {
              xPercent: -50,
            ...
            <span className="absolute inset-0 overflow-hidden [border-radius:inherit]">
              ...
              >
                <img
                  ...
                  draggable={false}
                  onError={(e) => {
                    (e.target as HTMLImageElement).src = "data:image/svg+xml;utf8,<svg xmlns='http://www.w3.org/2000/svg' width='400' height='600' viewBox='0 0 100 100'><rect width='100%' height='100%' fill='%231a1a1a'/><text y='50' x='50' font-size='8' text-anchor='middle' fill='%23888888'>SEAFOOD EXHIBIT</text></svg>";
                  }}
